...
-- Select com asteristco tras todas as colunas
...
-- Select limitando a quantidade de resultados
select cpf, nome from tbcliente limit 5;

-- Alias ou apelido
select cpf as cpf_cliente, nome as nome_cliente from tbcliente;

-- Combinar select com critério where
select * from tbcliente where cidade='Rio de janeiro';

select * from tbproduto where sabor='Limão';

-- Mudar dados da coluna sabor
...
select * from tbproduto where preco_lista between  16.007 and 18.009;
